---
{"dg-publish":true,"permalink":"/Work/Script/PHP/Frame/Hyperf/Hyperf 协程混淆/","title":"Hyperf 协程混淆","tags":["flashcards","#hyperf","#coroutineConfusion"],"noteIcon":"","created":"2026-09-03T10:00:35.000+08:00","updated":"2026-09-03T10:00:35.000+08:00","dg-note-properties":{"title":"Hyperf 协程混淆","tags":["flashcards","#hyperf","#coroutineConfusion"],"reference linking":null}}
---
...
```
输出：`counter: 2`。
`Atomic` 更适合==1;;原子==更新，不适合包含多个步骤的复杂临界区。
### 3. 利用 Channel 进行通信
